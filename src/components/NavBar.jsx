...
const NavBar = () => {
    return (
        <div className='flex items-center justify-between mt-[14px] mx-8'>
            {/* left side */}
            ...
            <div className='flex items-center justify-center gap-7'>
                ...
                <div className='flex items-center justify-center gap-6'>
                    <div className='flex items-center justify-center gap-2 text-sm font-normal font-lato text-[#2A2E3B]'>
                    ...
                    <div className='flex justify-center items-center gap-[9px] text-sm font-normal font-lato text-[#2A2E3B]'>
                        <span>USD $ / EN</span>
                    ...
                    <div className='px-2 text-sm font-normal font-lato text-[#2A2E3B]'>
                ...
                <div className='flex gap-3 rounded-md border border-black px-3 py-[10px]'>
